...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:site_name", content: "Viovox" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@deloment" },
    ],
    links: [
    ...
    scripts: [
      {
        children:
          "(function(){try{var t=localStorage.getItem('viovox-theme')||'auto';var m=window.matchMedia('(prefers-color-scheme: light)').matches;var l=t==='light'||(t==='auto'&&m);document.documentElement.classList.toggle('light',l);}catch(e){}})();",
      },
    ],
  }),
